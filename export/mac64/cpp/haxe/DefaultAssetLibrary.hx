...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/data/towns_map.csv", "assets/data/towns_map.csv");
		type.set ("assets/data/towns_map.csv", AssetType.TEXT);
		...
		path.set ("assets/images/buildings.png", "assets/images/buildings.png");
		type.set ("assets/images/buildings.png", AssetType.IMAGE);
		...
		path.set ("assets/images/Tiles/wheat_farm.png", "assets/images/Tiles/wheat_farm.png");
		type.set ("assets/images/Tiles/wheat_farm.png", AssetType.IMAGE);
		path.set ("assets/images/Tiles/wheat_farm_transparent.png", "assets/images/Tiles/wheat_farm_transparent.png");
		type.set ("assets/images/Tiles/wheat_farm_transparent.png", AssetType.IMAGE);
		path.set ("assets/images/towns.png", "assets/images/towns.png");
		type.set ("assets/images/towns.png", AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.FONT);
		id = "assets/images/buildings.png";
		path.set (id, id);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Tiles/wheat_farm.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Tiles/wheat_farm_transparent.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/towns.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
