...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/data/towns_map.csv", Reflect.field (AssetType, "text".toUpperCase ()));
			...
			type.set ("assets/images/buildings.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/Tiles/wheat_farm.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/Tiles/wheat_farm_transparent.png", "assets/images/Tiles/wheat_farm_transparent.png");
			type.set ("assets/images/Tiles/wheat_farm_transparent.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/towns.png", "assets/images/towns.png");
			type.set ("assets/images/towns.png", Reflect.field (AssetType, "image".toUpperCase ()));
