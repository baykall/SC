...
Void FlxBar_obj::destroy( ){
{
		...
		HX_STACK_LINE(206)
		::openfl::_v2::display::BitmapData _g1 = ::flixel::util::FlxDestroyUtil_obj::dispose(this->emptyBar);		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(206)
		this->emptyBar = _g1;
		HX_STACK_LINE(207)
		::openfl::_v2::display::BitmapData _g2 = ::flixel::util::FlxDestroyUtil_obj::dispose(this->filledBar);		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(207)
		this->filledBar = _g2;
		HX_STACK_LINE(209)
		this->super::destroy();
	...
	HX_STACK_ARG(border,"border")
{
		...
		if ((showBorder)){
			...
			if (((_g3 == false))){
				HX_STACK_LINE(425)
				::openfl::_v2::display::BitmapData emptyBar = ::openfl::_v2::display::BitmapData_obj::__new(this->barWidth,this->barHeight,true,border,null());		HX_STACK_VAR(emptyBar,"emptyBar");
				HX_STACK_LINE(426)
				::openfl::_v2::geom::Rectangle _g4 = ::openfl::_v2::geom::Rectangle_obj::__new((int)1,(int)1,(this->barWidth - (int)2),(this->barHeight - (int)2));		HX_STACK_VAR(_g4,"_g4");
				HX_STACK_LINE(426)
			...
			if (((_g6 == false))){
				HX_STACK_LINE(433)
				::openfl::_v2::display::BitmapData filledBar = ::openfl::_v2::display::BitmapData_obj::__new(this->barWidth,this->barHeight,true,border,null());		HX_STACK_VAR(filledBar,"filledBar");
				HX_STACK_LINE(434)
				::openfl::_v2::geom::Rectangle _g7 = ::openfl::_v2::geom::Rectangle_obj::__new((int)1,(int)1,(this->barWidth - (int)2),(this->barHeight - (int)2));		HX_STACK_VAR(_g7,"_g7");
				HX_STACK_LINE(434)
			...
			if (((_g9 == false))){
				HX_STACK_LINE(451)
				::openfl::_v2::display::BitmapData emptyBar = ::openfl::_v2::display::BitmapData_obj::__new(this->barWidth,this->barHeight,true,empty,null());		HX_STACK_VAR(emptyBar,"emptyBar");
				HX_STACK_LINE(452)
				::flixel::FlxG_obj::bitmap->addWithSpaces(emptyBar,(int)0,(int)0,(int)1,(int)1,false,emptyKey);
			}
			HX_STACK_LINE(455)
			...
			if (((_g11 == false))){
				HX_STACK_LINE(457)
				::openfl::_v2::display::BitmapData filledBar = ::openfl::_v2::display::BitmapData_obj::__new(this->barWidth,this->barHeight,true,fill,null());		HX_STACK_VAR(filledBar,"filledBar");
				HX_STACK_LINE(458)
				::flixel::FlxG_obj::bitmap->addWithSpaces(filledBar,(int)0,(int)0,(int)1,(int)1,false,filledKey);
			}
		}
	...
	HX_STACK_ARG(border,"border")
{
		...
		if ((showBorder)){
			...
			if (((_g9 == false))){
				HX_STACK_LINE(573)
				::openfl::_v2::display::BitmapData emptyBar = ::flixel::util::FlxGradient_obj::createGradientBitmapData(this->barWidth,this->barHeight,empty,chunkSize,rotation,null());		HX_STACK_VAR(emptyBar,"emptyBar");
				HX_STACK_LINE(574)
				::flixel::FlxG_obj::bitmap->addWithSpaces(emptyBar,(int)0,(int)0,(int)1,(int)1,false,emptyKey);
			}
			HX_STACK_LINE(577)
			...
			if (((_g11 == false))){
				HX_STACK_LINE(579)
				::openfl::_v2::display::BitmapData filledBar = ::flixel::util::FlxGradient_obj::createGradientBitmapData(this->barWidth,this->barHeight,fill,chunkSize,rotation,null());		HX_STACK_VAR(filledBar,"filledBar");
				HX_STACK_LINE(580)
				::flixel::FlxG_obj::bitmap->addWithSpaces(filledBar,(int)0,(int)0,(int)1,(int)1,false,filledKey);
			}
		}
	...
	HX_STACK_ARG(fillBackground,"fillBackground")
{
		...
		HX_STACK_LINE(617)
		::openfl::_v2::display::BitmapData emptyBitmapData;		HX_STACK_VAR(emptyBitmapData,"emptyBitmapData");
		HX_STACK_LINE(617)
		...
		HX_STACK_LINE(618)
		::openfl::_v2::display::BitmapData fillBitmapData;		HX_STACK_VAR(fillBitmapData,"fillBitmapData");
		HX_STACK_LINE(618)
		...
		if (((bool((empty != null())) && bool((fill == null()))))){
			...
			if (((_g11 == false))){
				HX_STACK_LINE(696)
				::openfl::_v2::display::BitmapData filledBar = ::openfl::_v2::display::BitmapData_obj::__new(this->barWidth,this->barHeight,true,fillBackground,null());		HX_STACK_VAR(filledBar,"filledBar");
				HX_STACK_LINE(697)
				::flixel::FlxG_obj::bitmap->addWithSpaces(filledBar,(int)0,(int)0,(int)1,(int)1,false,filledKey);
			}
		}
			...
			if (((bool((empty == null())) && bool((fill != null()))))){
				...
				if (((_g15 == false))){
					HX_STACK_LINE(728)
					::openfl::_v2::display::BitmapData emptyBar = ::openfl::_v2::display::BitmapData_obj::__new(this->barWidth,this->barHeight,true,emptyBackground,null());		HX_STACK_VAR(emptyBar,"emptyBar");
					HX_STACK_LINE(729)
					::flixel::FlxG_obj::bitmap->addWithSpaces(emptyBar,(int)0,(int)0,(int)1,(int)1,false,emptyKey);
				}
				HX_STACK_LINE(732)
...
Void FlxBar_obj::updateFrameData( ){
{
		...
		HX_STACK_LINE(1146)
		{
			...
			HX_STACK_LINE(1146)
			::openfl::_v2::geom::Rectangle tileRect = ::openfl::_v2::geom::Rectangle_obj::__new((int)0,(int)0,this->barWidth,this->barHeight);		HX_STACK_VAR(tileRect,"tileRect");
			HX_STACK_LINE(1146)
			::openfl::_v2::geom::Point point = ::openfl::_v2::geom::Point_obj::__new((0.5 * this->barWidth),(0.5 * this->barHeight));		HX_STACK_VAR(point,"point");
			HX_STACK_LINE(1146)
		...
		HX_STACK_LINE(1155)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(1223)
				{
					...
					HX_STACK_LINE(1223)
					::openfl::_v2::geom::Rectangle tileRect = ::openfl::_v2::geom::Rectangle_obj::__new(frameX,frameY,frameWidth,frameHeight);		HX_STACK_VAR(tileRect,"tileRect");
					HX_STACK_LINE(1223)
					::openfl::_v2::geom::Point point = ::openfl::_v2::geom::Point_obj::__new((0.5 * frameWidth),(0.5 * frameHeight));		HX_STACK_VAR(point,"point");
					HX_STACK_LINE(1223)
...
Dynamic FlxBar_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"emptyBar") ) { emptyBar=inValue.Cast< ::openfl::_v2::display::BitmapData >(); return inValue; }
		break;
	case 9:
		...
		if (HX_FIELD_EQ(inName,"filledBar") ) { filledBar=inValue.Cast< ::openfl::_v2::display::BitmapData >(); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"zeroOffset") ) { zeroOffset=inValue.Cast< ::openfl::_v2::geom::Point >(); return inValue; }
		break;
	case 11:
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"emptyBarRect") ) { emptyBarRect=inValue.Cast< ::openfl::_v2::geom::Rectangle >(); return inValue; }
	...
	case 13:
		...
		if (HX_FIELD_EQ(inName,"emptyBarPoint") ) { emptyBarPoint=inValue.Cast< ::openfl::_v2::geom::Point >(); return inValue; }
		if (HX_FIELD_EQ(inName,"filledBarRect") ) { filledBarRect=inValue.Cast< ::openfl::_v2::geom::Rectangle >(); return inValue; }
	...
	case 14:
		...
		if (HX_FIELD_EQ(inName,"filledBarPoint") ) { filledBarPoint=inValue.Cast< ::openfl::_v2::geom::Point >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_v2::display::BitmapData*/ ,(int)offsetof(FlxBar_obj,emptyBar),HX_CSTRING("emptyBar")},
	{hx::fsObject /*::openfl::_v2::geom::Rectangle*/ ,(int)offsetof(FlxBar_obj,emptyBarRect),HX_CSTRING("emptyBarRect")},
	{hx::fsObject /*::openfl::_v2::geom::Point*/ ,(int)offsetof(FlxBar_obj,emptyBarPoint),HX_CSTRING("emptyBarPoint")},
	{hx::fsBool,(int)offsetof(FlxBar_obj,emptyKill),HX_CSTRING("emptyKill")},
	{hx::fsObject /*::openfl::_v2::geom::Point*/ ,(int)offsetof(FlxBar_obj,zeroOffset),HX_CSTRING("zeroOffset")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(FlxBar_obj,filledCallback),HX_CSTRING("filledCallback")},
	{hx::fsObject /*::openfl::_v2::display::BitmapData*/ ,(int)offsetof(FlxBar_obj,filledBar),HX_CSTRING("filledBar")},
	{hx::fsObject /*::openfl::_v2::geom::Rectangle*/ ,(int)offsetof(FlxBar_obj,filledBarRect),HX_CSTRING("filledBarRect")},
	{hx::fsObject /*::openfl::_v2::geom::Point*/ ,(int)offsetof(FlxBar_obj,filledBarPoint),HX_CSTRING("filledBarPoint")},
