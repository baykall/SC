...
#include <Type.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_opensans_bold_ttf
#include <__ASSET__assets_fonts_opensans_bold_ttf.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_opensans_bolditalic_ttf
#include <__ASSET__assets_fonts_opensans_bolditalic_ttf.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_opensans_extrabold_ttf
#include <__ASSET__assets_fonts_opensans_extrabold_ttf.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_opensans_extrabolditalic_ttf
#include <__ASSET__assets_fonts_opensans_extrabolditalic_ttf.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_opensans_italic_ttf
#include <__ASSET__assets_fonts_opensans_italic_ttf.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_opensans_light_ttf
#include <__ASSET__assets_fonts_opensans_light_ttf.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_opensans_lightitalic_ttf
#include <__ASSET__assets_fonts_opensans_lightitalic_ttf.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_opensans_regular_ttf
#include <__ASSET__assets_fonts_opensans_regular_ttf.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_opensans_semibold_ttf
#include <__ASSET__assets_fonts_opensans_semibold_ttf.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_opensans_semibolditalic_ttf
#include <__ASSET__assets_fonts_opensans_semibolditalic_ttf.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_quicksand_bold_otf
#include <__ASSET__assets_fonts_quicksand_bold_otf.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_quicksand_bolditalic_otf
#include <__ASSET__assets_fonts_quicksand_bolditalic_otf.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_quicksand_dash_otf
#include <__ASSET__assets_fonts_quicksand_dash_otf.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_quicksand_italic_otf
#include <__ASSET__assets_fonts_quicksand_italic_otf.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_quicksand_light_otf
#include <__ASSET__assets_fonts_quicksand_light_otf.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_quicksand_lightitalic_otf
#include <__ASSET__assets_fonts_quicksand_lightitalic_otf.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_quicksand_regular_otf
#include <__ASSET__assets_fonts_quicksand_regular_otf.h>
#endif
...
HX_STACK_THIS(this)
{
	...
	super::__construct();
	HX_STACK_LINE(355)
	::openfl::_v2::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__assets_fonts_opensans_bold_ttf >());
	HX_STACK_LINE(356)
	::openfl::_v2::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__assets_fonts_opensans_bolditalic_ttf >());
	HX_STACK_LINE(357)
	::openfl::_v2::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__assets_fonts_opensans_extrabold_ttf >());
	HX_STACK_LINE(358)
	::openfl::_v2::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__assets_fonts_opensans_extrabolditalic_ttf >());
	HX_STACK_LINE(359)
	::openfl::_v2::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__assets_fonts_opensans_italic_ttf >());
	HX_STACK_LINE(360)
	::openfl::_v2::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__assets_fonts_opensans_light_ttf >());
	HX_STACK_LINE(361)
	::openfl::_v2::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__assets_fonts_opensans_lightitalic_ttf >());
	HX_STACK_LINE(362)
	::openfl::_v2::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__assets_fonts_opensans_regular_ttf >());
	HX_STACK_LINE(363)
	::openfl::_v2::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__assets_fonts_opensans_semibold_ttf >());
	HX_STACK_LINE(364)
	::openfl::_v2::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__assets_fonts_opensans_semibolditalic_ttf >());
	HX_STACK_LINE(365)
	::openfl::_v2::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__assets_fonts_quicksand_bold_otf >());
	HX_STACK_LINE(366)
	::openfl::_v2::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__assets_fonts_quicksand_bolditalic_otf >());
	HX_STACK_LINE(367)
	::openfl::_v2::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__assets_fonts_quicksand_italic_otf >());
	HX_STACK_LINE(368)
	::openfl::_v2::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__assets_fonts_quicksand_light_otf >());
	HX_STACK_LINE(369)
	::openfl::_v2::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__assets_fonts_quicksand_lightitalic_otf >());
	HX_STACK_LINE(370)
	::openfl::_v2::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__assets_fonts_quicksand_regular_otf >());
	HX_STACK_LINE(371)
	::openfl::_v2::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__assets_fonts_quicksand_dash_otf >());
	HX_STACK_LINE(411)
	...
	if ((useManifest)){
		...
		if (((_g1 > (int)-1))){
			...
			Void run(){
				HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","DefaultAssetLibrary.hx",482,0x0fc48912)
				{
					HX_STACK_LINE(484)
...
bool DefaultAssetLibrary_obj::exists( ::String id,::openfl::_v2::AssetType type){
	HX_STACK_FRAME("DefaultAssetLibrary","exists",0x972074de,"DefaultAssetLibrary.exists","DefaultAssetLibrary.hx",515,0x0fc48912)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
...
::openfl::_v2::display::BitmapData DefaultAssetLibrary_obj::getBitmapData( ::String id){
	HX_STACK_FRAME("DefaultAssetLibrary","getBitmapData",0xb8207f2d,"DefaultAssetLibrary.getBitmapData","DefaultAssetLibrary.hx",590,0x0fc48912)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(590)
...
::openfl::_v2::utils::ByteArray DefaultAssetLibrary_obj::getBytes( ::String id){
	HX_STACK_FRAME("DefaultAssetLibrary","getBytes",0x86b4b377,"DefaultAssetLibrary.getBytes","DefaultAssetLibrary.hx",636,0x0fc48912)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(636)
	if ((this->className->exists(id))){
...
::openfl::_v2::text::Font DefaultAssetLibrary_obj::getFont( ::String id){
	HX_STACK_FRAME("DefaultAssetLibrary","getFont",0x974ed843,"DefaultAssetLibrary.getFont","DefaultAssetLibrary.hx",656,0x0fc48912)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(656)
	if ((this->className->exists(id))){
...
::openfl::_v2::media::Sound DefaultAssetLibrary_obj::getMusic( ::String id){
	HX_STACK_FRAME("DefaultAssetLibrary","getMusic",0xd9777bb1,"DefaultAssetLibrary.getMusic","DefaultAssetLibrary.hx",690,0x0fc48912)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(690)
	if ((this->className->exists(id))){
...
::String DefaultAssetLibrary_obj::getPath( ::String id){
	HX_STACK_FRAME("DefaultAssetLibrary","getPath",0x9de06019,"DefaultAssetLibrary.getPath","DefaultAssetLibrary.hx",706,0x0fc48912)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(706)
...
::openfl::_v2::media::Sound DefaultAssetLibrary_obj::getSound( ::String id){
	HX_STACK_FRAME("DefaultAssetLibrary","getSound",0x49e937db,"DefaultAssetLibrary.getSound","DefaultAssetLibrary.hx",729,0x0fc48912)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(729)
	if ((this->className->exists(id))){
...
::String DefaultAssetLibrary_obj::getText( ::String id){
	HX_STACK_FRAME("DefaultAssetLibrary","getText",0xa0884721,"DefaultAssetLibrary.getText","DefaultAssetLibrary.hx",737,0x0fc48912)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(770)
...
bool DefaultAssetLibrary_obj::isLocal( ::String id,::openfl::_v2::AssetType type){
	HX_STACK_FRAME("DefaultAssetLibrary","isLocal",0x968237df,"DefaultAssetLibrary.isLocal","DefaultAssetLibrary.hx",799,0x0fc48912)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(type,"type")
	HX_STACK_LINE(799)
...
Array< ::String > DefaultAssetLibrary_obj::list( ::openfl::_v2::AssetType type){
	HX_STACK_FRAME("DefaultAssetLibrary","list",0xf3604ee0,"DefaultAssetLibrary.list","DefaultAssetLibrary.hx",804,0x0fc48912)
	HX_STACK_THIS(this)
	HX_STACK_ARG(type,"type")
	HX_STACK_LINE(806)
...
{
		HX_STACK_FRAME("DefaultAssetLibrary","loadBitmapData",0x9243e881,"DefaultAssetLibrary.loadBitmapData","DefaultAssetLibrary.hx",823,0x0fc48912)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
...
{
		HX_STACK_FRAME("DefaultAssetLibrary","loadBytes",0x8c71caa3,"DefaultAssetLibrary.loadBytes","DefaultAssetLibrary.hx",856,0x0fc48912)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(886)
...
{
		HX_STACK_FRAME("DefaultAssetLibrary","loadFont",0x1da5ca97,"DefaultAssetLibrary.loadFont","DefaultAssetLibrary.hx",893,0x0fc48912)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(915)
...
{
		HX_STACK_FRAME("DefaultAssetLibrary","loadManifest",0x6f596c77,"DefaultAssetLibrary.loadManifest","DefaultAssetLibrary.hx",925,0x0fc48912)
		HX_STACK_THIS(this)
		HX_STACK_LINE(925)
		try
		{
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			...
			if (((bytes != null()))){
							...
							while((true)){
								...
								struct _Function_7_1{
									inline static bool Block( hx::ObjectPtr< ::DefaultAssetLibrary_obj > __this,Dynamic &asset){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","DefaultAssetLibrary.hx",951,0x0fc48912)
										{
											HX_STACK_LINE(951)
				...
				HX_STACK_LINE(966)
				::haxe::Log_obj::trace(HX_CSTRING("Warning: Could not load asset manifest (bytes was null)"),hx::SourceInfo(HX_CSTRING("DefaultAssetLibrary.hx"),966,HX_CSTRING("DefaultAssetLibrary"),HX_CSTRING("loadManifest")));
			}
		}
		}
		catch(Dynamic __e){
			{
				...
				Dynamic e = __e;{
					...
					HX_STACK_LINE(972)
					::haxe::Log_obj::trace(_g2,hx::SourceInfo(HX_CSTRING("DefaultAssetLibrary.hx"),972,HX_CSTRING("DefaultAssetLibrary"),HX_CSTRING("loadManifest")));
				}
			}
		}
	}
...
{
		HX_STACK_FRAME("DefaultAssetLibrary","loadMusic",0xdf3492dd,"DefaultAssetLibrary.loadMusic","DefaultAssetLibrary.hx",980,0x0fc48912)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(1002)
...
{
		HX_STACK_FRAME("DefaultAssetLibrary","loadSound",0x4fa64f07,"DefaultAssetLibrary.loadSound","DefaultAssetLibrary.hx",1009,0x0fc48912)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(1031)
...
{
		HX_STACK_FRAME("DefaultAssetLibrary","loadText",0x26df3975,"DefaultAssetLibrary.loadText","DefaultAssetLibrary.hx",1038,0x0fc48912)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(handler,"handler")
		HX_STACK_LINE(1038)
		...
		Void run(::openfl::_v2::utils::ByteArray bytes){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","DefaultAssetLibrary.hx",1062,0x0fc48912)
